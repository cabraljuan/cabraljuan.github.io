...
\section*{Calificación de las restricciones}
...
En consecuencia, la condición de independencia lineal de gradientes no se cumple en este punto. Tampoco se cumplen que las restricciones sean cóncavas ni lineales y por esa razón las condiciones de primer orden dejan de ser válidas. \\
Véamos qué sucede si agregamos una nueva restricción al problema pero que no cambia el punto óptimo:
\[
\begin{aligned}
&\max_{x_1,x_2}\ f=x_1\\
&\text{s.a.}\ 
\begin{cases}
g_1(x)\equiv x_2-(1-x_1)^3 \le 0,\\
g_3(x)\equiv x_1,x_2 \geq 0,\\
g_4(x)\equiv 2x_1+x_2-2 \le 0.
\end{cases}
\end{aligned}
\]

\textbf{Punto candidato: } \(x^*=(1,0)\).
\[
g_1(1,0)=0,\qquad g_3(1,0)=0,\qquad g_4(1,0)=0,
\]
o sea, \(g_1,g_3,g_4\) están \emph{activas}.

\textbf{Gradientes:}
\[
\nabla g_1(x_1,x_2)=\big(3(1-x_1)^2,\,1\big),\quad
\nabla g_3(x_1,x_2)=(0,-1),\quad
\nabla g_4(x_1,x_2)=(2,1).
\]
\[
\nabla g_1(1,0)=(0,1),\qquad
\nabla g_3(1,0)=(0,-1),\qquad
\nabla g_4(1,0)=(2,1).
\]

\textbf{Chequeo de calificación de restricciones}
Formamos la matriz jacobiana de restricciones activas en \(x^*\):
\[
J(x^*)=
\begin{bmatrix}
0 & 1\\
...
\end{bmatrix}.
\]
Su rango es 2 (por ejemplo, las filas \((0,1)\) y \((2,1)\) son linealmente independientes).
Como \(2=n\), los gradientes de las restricciones activas \emph{generan} \(\mathbb R^2\)
(rango completo). Por lo tanto, se cumple una calificación de restricciones estándar y por lo tanto las condiciones de primer orden vuelven a ser válidas. Aunque \(g_1\) y \(g_3\) son colineales entre sí, la presencia de la tercera
frontera \(g_4\) aporta una normal no colineal; el conjunto de gradientes activos tiene rango \(2\),
suficiente en dimensión \(n=2\). Veamos de resolver el problema nuevamente:
...
\[
\mathcal L(x_1,x_2,\lambda_1,\lambda_2)
= x_1
+ \lambda_1\bigl((1 - x_1)^3 - x_2\bigr)
+ \lambda_2\bigl(2 - 2x_1 - x_2\bigr).
\]
...
\begin{aligned}
&\frac{\partial\mathcal L}{\partial x_1}
= 1 - 3\lambda_1(1 - x_1)^2 - 2\lambda_2 \;\le 0,
\quad x_1 \ge 0,\quad
x_1\!\left[1 - 3\lambda_1(1 - x_1)^2 - 2\lambda_2\right]=0,\\[0.6em]
&\frac{\partial\mathcal L}{\partial x_2}
= -\lambda_1 - \lambda_2 \;\le 0,
\quad x_2 \ge 0,\quad
x_2(-\lambda_1 - \lambda_2)=0,\\[0.6em]
&\frac{\partial\mathcal L}{\partial \lambda_1}
= (1 - x_1)^3 - x_2 \;\ge 0,
\quad \lambda_1 \ge 0,\quad
\lambda_1\bigl((1 - x_1)^3 - x_2\bigr)=0,\\[0.6em]
&\frac{\partial\mathcal L}{\partial \lambda_2}
= 2 - 2x_1 - x_2 \;\ge 0,
\quad \lambda_2 \ge 0,\quad
\lambda_2\bigl(2 - 2x_1 - x_2\bigr)=0.
\end{aligned}
\]

En el punto \(x^*=(1,0)\):
\[
(1 - x_1)^3 - x_2 = 0,\quad 2 - 2x_1 - x_2 = 0,
\]
ambas restricciones son activas.

Sustituyendo \(x_1=1,\ x_2=0\) en las derivadas:
\[
\begin{cases}
1 - 3\lambda_1(1 - 1)^2 - 2\lambda_2 = 1 - 2\lambda_2 \le 0,\\[0.4em]
-\lambda_1 - \lambda_2 \le 0.
\end{cases}
\]


De la primera ecuación se obtiene \(1 - 2\lambda_2 = 0 \Rightarrow \lambda_2 = \tfrac{1}{2}\).


Por lo tanto,
\[\color{teal}
{x^*=(1,0) \quad \lambda_2=\tfrac{1}{2}}
\]
cumple las condiciones de Kuhn–Tucker y representa un óptimo local.  
