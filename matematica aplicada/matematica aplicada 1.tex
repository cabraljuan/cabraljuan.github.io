...
\frac{dz}{dt}
=
(2uv)(1\cdot 1+1\cdot 2t)
+
(u^{2})(s\cdot 2t+q\cdot e^{t})
\]
\[
=
2uv(1+2t)+u^{2}(2ts+qe^{t})
\]

Sustituyendo \(u=p+q=t+t^{2}\), \(v=qs=t^{2}e^{t}\), \(s=e^{t}\) y \(q=t^{2}\)
\[
\frac{dz}{dt}
=
2(t+t^{2})(t^{2}e^{t})(1+2t)
+
(t+t^{2})^{2}(2te^{t}+t^{2}e^{t})
\]
\[
=
2(t+t^{2})(t^{2}e^{t})(1+2t)
...
Como
\[
z(t)=u(t)^{2}v(t)=(t+t^{2})^{2}(t^{2}e^{t})=t^{4}(1+t)^{2}e^{t}
\]

derivando directamente
\[
\frac{d}{dt}\Big(t^{4}(1+t)^{2}e^{t}\Big)
=
e^{t}t^{3}(1+t)(4+7t+t^{2})
\]
